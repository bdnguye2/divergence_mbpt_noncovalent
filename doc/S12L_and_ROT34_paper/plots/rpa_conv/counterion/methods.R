...
postscript("s30l-ci.eps", width = 3.25, height = 2.25, paper="special", horizontal=FALSE)
...
title(ylab=expression(paste(Delta,italic(E)^{RPA},' (kcal/mol)')),line=1.5,cex.lab=0.8)
