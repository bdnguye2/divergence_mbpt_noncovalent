...
axis(1,xaxp=c(2,11,9),cex.axis=1,col=NA,line=-0.4)
axis(1,xaxp=c(2,11,9),label=FALSE,tck=-0.04,lwd=2)
...
par(fig=c(0.12,0.6, 0.55, 0.98),new=T)
plot(dataX,dataComp5,type="o",pch=1,cex=1,lwd=1.5,lty=1,
     yaxt="n",xaxt="n",ylim=c(-100,200),ann=FALSE,xlim=c(2,5.2))
box(lwd=2)
...
axis(2,yaxp=c(-100,200,3),cex.axis=1,las=2,col=NA,line=-0.4)
axis(2,yaxp=c(-100,200,3),label=FALSE,tck=-0.08,lwd=2)
